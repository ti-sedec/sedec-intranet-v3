...
export interface ApiAniversarianteAniversariante
  extends Struct.CollectionTypeSchema {
  collectionName: 'aniversariantes';
  info: {
    displayName: 'Aniversariante';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataAniversario: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    agendaUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLinkUtilLinkUtil extends Struct.CollectionTypeSchema {
  collectionName: 'links_uteis';
  info: {
    displayName: 'Link \u00DAtil';
    pluralName: 'links-uteis';
    singularName: 'link-util';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::link-util.link-util': ApiLinkUtilLinkUtil;
